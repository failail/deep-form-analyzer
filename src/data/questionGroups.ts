...
export const QUESTION_GROUPS: QuestionGroup[] = [
  // GROUP 1: PERSONAL BASICS
  {
    ...
    questions: [
      ...
      // Trigger questions for conditional groups (Questions 15-20)
      {
        id: 'hasVehicles',
...
export const QUESTIONS = QUESTION_GROUPS.flatMap(group => group.questions);, message: 'Only letters and spaces allowed' }
        ],
        section: 'Personal Information',
        questionNumber: 14,
        groupId: 'personal-basics'
